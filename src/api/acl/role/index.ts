...
import { ResponseRoleData, SetRoleResponse ,TreeResponseData} from '@/api/acl/role/type'
enum API {
...
export const reqSetPermission = () => request.get<any, TreeResponseData>(API.SETPERMISSION_URL)
export const reqGetRolePermission = (id:number) => request.get<any, TreeResponseData>(API.GETROLEPERMISSION_URL+id)
